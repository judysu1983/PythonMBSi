...
AppPath=r'C:\Depots\MBSI\Projects\AX\CostAccounting\UI'
...
for lang in langs:
   ...
   for f1 in files:
       ...
       if os.path.isfile(os.path.join(AX7path,lang,'Application',dllf1)):
           print(dllf1)
           if not os.path.exists(os.path.join(AppPath,lang)):
               os.makedirs(os.path.join(AppPath,lang))
           shutil.copy2(os.path.join(AX7path,lang,'Application',dllf1),os.path.join(AppPath,lang,labelf1))
