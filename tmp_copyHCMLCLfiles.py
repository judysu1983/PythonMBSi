...
def copyLCL(Component,fileList):
    ...
    GitLCLpath=os.path.join('C:\\test\\3972731\\')+Component+'\\source\\Translation\\LCL'
    print(GitLCLpath)
    ...
    SDpath=r'C:\CTAS\OOBAPPs\runs\20180503-225312-1x91ahmkw2\work'
    for lang in langs:
        for f in fileList:
