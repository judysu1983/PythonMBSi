...
#langs=['master']
AX7path=r'C:\Gitprojects\Cost Accounting\source\Translation\LCL'
...
for lang in langs:
   ...
   for f1 in files:
       ...
       if os.path.isfile(os.path.join(AX7path,lang,dllf1)):
           ...
           if not os.path.exists(os.path.join(AppPath,lang,'CostAccounting')):
               os.makedirs(os.path.join(AppPath,lang,'CostAccounting'))
           shutil.copy2(os.path.join(AX7path,lang,dllf1),os.path.join(AppPath,lang,'CostAccounting',labelf1))
