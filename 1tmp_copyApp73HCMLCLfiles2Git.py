...
##AccountingFoundationfiles=["CurrencyExchange.en-US.label.txt.lcl"]
...
ElectronicReportingfiles=["TaxEngineInterface.en-US.label.txt.lcl"]
...
def copyLCL(Component,fileList):
    ...
    SDpath=r'C:\CTAS\App73\runs\20180730-182239-a368mw2v9\work'
    for lang in langs:
        for f in fileList:
