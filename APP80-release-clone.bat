...
cd C:\test\%clonefolder%
git clone "https://msdyneng.visualstudio.com/AX%20Application/_git/ApplicationIntegration"
cd ApplicationIntegration
git checkout -f release/App80
git pull
...
rem git checkout release/App80
rem git pull